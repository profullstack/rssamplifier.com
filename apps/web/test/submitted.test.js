...
test('the cap counts lines, not characters', () => {
  // The point of the unit. A paste is long in feeds, not in bytes: fifty
  // thousand characters stopped at a few hundred URLs, so a list well inside
  // the line cap has to survive whole.
