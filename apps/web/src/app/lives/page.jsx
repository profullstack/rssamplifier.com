...
const CATEGORY = CATEGORIES.live;
 ...
 * @param {{ searchParams: Promise<Record<string, string|string[]|undefined>> }} props
 */
export default async function LivesPage({ searchParams }) {
  return <CategoryIndex kind="live" page={pageNumber((await searchParams).page)} />;
}
